...
_G.packer_plugins = {
  ...
  ["lsp-colors.nvim"] = {
    loaded = true,
    path = "/home/taloud/.local/share/nvim/site/pack/packer/start/lsp-colors.nvim",
  ...
  ["nlsp-settings.nvim"] = {
    loaded = true,
    path = "/home/taloud/.local/share/nvim/site/pack/packer/start/nlsp-settings.nvim",
  ...
  phpactor = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/taloud/.local/share/nvim/site/pack/packer/opt/phpactor",
